...
public class VoiceCallActivity extends AppCompatActivity {
            ...
            if (ngnAVSession != null) {
                ...
                if (ngnAVSession != null) {
                    ...
                    if (!ngnAVSession.sendDTMF(character)) {
                        ...
                        Log.e(Constants.TAG, "Succeeded to send DTMF " + character);
                    }
                }
            }
        }
    ...
    public void configureStack() {
        ...
        // Add this so it doesn't break
//        ngnConfigurationService.putBoolean(NgnConfigurationEntry.NATT_USE_STUN_FOR_SIP, true, true);
